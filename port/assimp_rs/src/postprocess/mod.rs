...
bitflags::bitflags! {
    ...
    pub struct AiPostProcessSteps: u32 {
        ...
        ///
        const JoinIdenticalVertices = 1 << 1;
        ...
        /// range.
        ///
        const PreTransformVertices = 1 << 8;
        ...
        ///
        const ValidateDataStructure = 1 << 10;
        ...
        ///
        const ImproveCacheLocality = 1 << 11;
        ...
        ///
        const RemoveRedundantMaterials = 1 << 12;
        ...
        /// hard work for you :)
        ///
        const PopulateArmatureData = 1 << 14;
        ...
        ///
        const DropNormals = 1 << 30;

        const GenBoundingBoxes = 1 << 31;

        /// @def Preset_TargetRealtime_Fast
        ...
        ///
        const Preset_TargetRealtime_Fast = Self::CalcTangentSpace.bits()
                                        | Self::GenNormals.bits()
                                        | Self::JoinIdenticalVertices.bits()
                                        | Self::Triangulate.bits()
                                        | Self::GenUVCoords.bits()
                                        | Self::SortByPType.bits();

        /// @def Preset_TargetRealtime_Quality
        /// @brief Default postprocess configuration optimizing the data for real-time rendering.
        ///
        ...
        ///
        const Preset_TargetRealtime_Quality = Self::CalcTangentSpace.bits()
                                        | Self::GenSmoothNormals.bits()
                                        | Self::JoinIdenticalVertices.bits()
                                        | Self::ImproveCacheLocality.bits()
                                        | Self::LimitBoneWeights.bits()
                                        | Self::RemoveRedundantMaterials.bits()
                                        | Self::SplitLargeMeshes.bits()
                                        | Self::Triangulate.bits()
                                        | Self::GenUVCoords.bits()
                                        | Self::SortByPType.bits()
                                        | Self::FindDegenerates.bits()
                                        | Self::FindInvalidData.bits();

        /// @def Preset_TargetRealtime_MaxQuality
        /// @brief Default postprocess configuration optimizing the data for real-time rendering.
        ///
