...
use crate::structs::color::{Color3D, Color4D};
use crate::structs::key::{AiQuatKey, AiVectorKey};
use crate::structs::mesh::{AI_MAX_NUMBER_OF_COLOR_SETS, AI_MAX_NUMBER_OF_TEXTURECOORDS};
...
impl Default for Node {
    fn default() -> Self {
        Self {
            name: String::new(),
            transformation_matrix: Mat4::ZERO,
            parent: Index::new(0),
            children: Vec::new(),
            meshes: Vec::new(),
        }
