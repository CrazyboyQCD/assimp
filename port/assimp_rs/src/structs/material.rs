...
use crate::material::AiUVTransform;
...
impl AiProperty {
    match_fn_defines!(
        // f32 properties
        Floats, Vec<f32>, is_floats_property
        Float, f32, is_float_property
        // Vector properties
        Vec3, Vec3, is_vec3_property
        Vec4, Vec4, is_vec4_property
        // f64 properties
        Doubles, Vec<f64>, is_doubles_property
        Double, f64, is_double_property
        // i32 properties
